(function() {
    ...
    function Frame02() {
       ...
       t.delayedCall(3, Frame03);
        ...
        t.from(copy03, 1, { autoAlpha: 0, x: "-=20", ease: Power3.easeOut, delay: 1});
        t.from(copy04, 1, { autoAlpha: 0, x: "-=20", ease: Power3.easeOut, delay: 1.2});
        t.from(copy05, 1, { autoAlpha: 0, x: "-=20", ease: Power3.easeOut, delay: 1.4});
        t.from(copy06 , 1, { autoAlpha: 0, x: "-=20", ease: Power3.easeOut, delay: 1.6});
        ...
        t.from([cta, ctaCopy_off], 1, { autoAlpha: 0, y: "+=20", ease: Power3.easeOut, delay: 2, onComplete: function() { rolloverActive = true } });
