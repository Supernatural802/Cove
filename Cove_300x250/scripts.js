(function() {
    ...
    function Frame01() {
        ...
        t.from(logo01_dropShadow, 1, { autoAlpha: 0, ease: Power3.easeOut, delay: 1.5  });
       
        t.delayedCall(2.5, Frame02);
    };
    ...
    function Frame02() {
        ...
        // t.from(productShot_Highlight, .5, { autoAlpha: 0, repeat: 3, yoyo:true, ease: Power3.easeInOut, delay: 2 });
       ...
       t.delayedCall(3, Frame03);
        ...
        t.from(copy07, 1, { autoAlpha: 0, x: "-=20", ease: Power3.easeOut, delay: 1.6});
        ...
        t.from([bottomBar,cta,  ctaCopy_off], 1, { autoAlpha: 0, y: "+=50", ease: Power3.easeOut, delay: 2, onComplete: function() { rolloverActive = true } });
